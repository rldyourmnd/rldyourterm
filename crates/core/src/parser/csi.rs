...
impl Parser {
    ...
    fn private_mode_action(&self, mode: u16, final_byte: u8) -> Option<ParserAction> {
        match (mode, final_byte) {
            ...
            (5, b'h') => Some(ParserAction::SetReverseVideo(true)),
            (5, b'l') => Some(ParserAction::SetReverseVideo(false)),
            ...
            (9, b'h') => Some(ParserAction::SetMouseMode(MouseMode::X10)),
            (9, b'l') => Some(ParserAction::SetMouseMode(MouseMode::Off)),
            ...
            (1007, b'h') => Some(ParserAction::SetAlternateScroll(true)),
            (1007, b'l') => Some(ParserAction::SetAlternateScroll(false)),
            (1036, b'h') => Some(ParserAction::SetMetaSendsEscape(false)),
            (1036, b'l') => Some(ParserAction::SetMetaSendsEscape(true)),
            (1039, b'h') => Some(ParserAction::SetAltSendsEscape(true)),
            (1039, b'l') => Some(ParserAction::SetAltSendsEscape(false)),
