...
| R-12 | Manual-only release governance for v1.0.0 | `AGENTS.md`, `planning/v1.0.0-development-blueprint.md` | `planning/operations/v1.0.0-release-pack.md`, `planning/operations/v1.0.0-start-readiness-index.md` | Risk 8 | `python3 scripts/ci/refresh_release_evidence_manifest.py --output /tmp/rldyourterm-evidence-manifest.json`, `bash scripts/ci/validate_release_evidence_freshness.sh --manifest /tmp/rldyourterm-evidence-manifest.json --mode strict` |
